/*
 * Jquery Loader插件 中文叫菊花插件 需要jQuery.tmpl插件
 * 使用例子:
...
(function($) {
    $.loader_ext = {
        ...
        defaults : {
            ...
            title : '', //文字
            imgUrl : '/Common/images/icon/loading[size].gif',
        ...
        // 容器检测
        checkScope : function(){
            if(this.scope.is('body') || this.scope.is('div')){
                $.extend(this.options, {
                    size: 32,
                    imgUrl : '/Common/images/icon/blue_loading[size].gif'
                });
            }
        },
    ...
    $.fn.loader = function(arg){
        ...
        return $.loader_ext.init($(this),arg);
    };
